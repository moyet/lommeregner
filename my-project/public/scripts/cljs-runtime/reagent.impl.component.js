...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36237 = c;
var G__36237__$1 = (((G__36237 == null))?null:G__36237.prototype);
if((G__36237__$1 == null)){
return null;
} else {
return G__36237__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36241 = c;
var G__36241__$1 = (((G__36241 == null))?null:G__36241.prototype);
if((G__36241__$1 == null)){
return null;
} else {
return G__36241__$1.render;
}
})() == null)))));
});
...
var G__36253 = c;
var G__36253__$1 = (((G__36253 == null))?null:G__36253.constructor);
if((G__36253__$1 == null)){
return null;
} else {
return G__36253__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__36256 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__36257 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__36257);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__36256);
}});
...
var c = this;
var G__36267_36347 = goog.object.get(c,"cljsRatom");
if((G__36267_36347 == null)){
} else {
reagent.ratom.dispose_BANG_(G__36267_36347);
}
...
var renders_36353 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_36354 = cljs.core.first(cljs.core.vals(renders_36353));
...
if((cljs.core.count(renders_36353) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_36353))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_36354)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_36354], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__36268 = o;
goog.object.set(G__36268,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__36276 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__36277 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__36277);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__36276);
}});
...
var vec__36291 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36291,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36291,(1),null);
...
var G__36302 = goog.object.get(reagent_state,"cljsRatom");
if((G__36302 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__36302);
}
});
}),[]);
