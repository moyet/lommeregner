...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_26357 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_26357(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26363 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26363(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26366 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26366(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26370 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26370(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26377 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26377(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26383 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26383(reader);
}
});
...
var G__26457 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__26458 = s.append(c);
c = G__26457;
s = G__26458;
continue;
}
