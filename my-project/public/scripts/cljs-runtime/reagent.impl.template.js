...
var G__36364 = o;
goog.object.set(G__36364,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__36382__delegate = function (args){
...
while (G__36383__i < G__36383__a.length) {G__36383__a[G__36383__i] = arguments[G__36383__i + 0]; ++G__36383__i;}
  args = new cljs.core.IndexedSeq(G__36383__a,0,null);
} 
return G__36382__delegate.call(this,args);};
G__36382.cljs$lang$maxFixedArity = 0;
G__36382.cljs$lang$applyTo = (function (arglist__36384){
var args = cljs.core.seq(arglist__36384);
return G__36382__delegate(args);
});
...
var G__36365 = o;
goog.object.set(G__36365,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var args = null;
if (arguments.length > 0) {
var G__36395__i = 0, G__36395__a = new Array(arguments.length -  0);
while (G__36395__i < G__36395__a.length) {G__36395__a[G__36395__i] = arguments[G__36395__i + 0]; ++G__36395__i;}
  args = new cljs.core.IndexedSeq(G__36395__a,0,null);
} 
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36366__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__36367 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36367,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__36367;
}
})(),id_class);
...
var G__36368 = (cljs.core.count(argv) - first_child);
switch (G__36368) {
case (0):
...
var vec__36369 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36369,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36369,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36369,(2),null);
...
var temp__5739__auto___36417 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___36417 == null)){
} else {
var key_36421 = temp__5739__auto___36417;
(jsprops.key = key_36421);
}
...
var temp__5739__auto___36422 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___36422 == null)){
} else {
var key_36423 = temp__5739__auto___36422;
(jsprops.key = key_36423);
}
...
var temp__5739__auto___36424 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___36424 == null)){
} else {
var key_36425 = temp__5739__auto___36424;
(jsprops.key = key_36425);
}
...
var temp__5739__auto___36435 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
...
var temp__5739__auto___36437 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___36437 == null)){
} else {
var key_36438 = temp__5739__auto___36437;
(jsprops.key = key_36438);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36372_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__36372_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__36373 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36373,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36373,(1),null);
...
break;
default:
var G__36450 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__36451 = compiler;
v = G__36450;
compiler = G__36451;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template36379 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template36379 = (function (opts,id,fn_to_element,meta36380){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template36379.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_36381,meta36380__$1){
var self__ = this;
var _36381__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template36379(self__.opts,self__.id,self__.fn_to_element,meta36380__$1));
}));

(reagent.impl.template.t_reagent$impl$template36379.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_36381){
var self__ = this;
var _36381__$1 = this;
return self__.meta36380;
}));

(reagent.impl.template.t_reagent$impl$template36379.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template36379.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template36379.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template36379.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template36379.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta36380","meta36380",-2025328216,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template36379.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template36379.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template36379");

(reagent.impl.template.t_reagent$impl$template36379.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template36379");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template36379.
 */
reagent.impl.template.__GT_t_reagent$impl$template36379 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template36379(opts__$1,id__$1,fn_to_element__$1,meta36380){
return (new reagent.impl.template.t_reagent$impl$template36379(opts__$1,id__$1,fn_to_element__$1,meta36380));
});

}

return (new reagent.impl.template.t_reagent$impl$template36379(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
